import { Cartesian2, Cartesian3, Color, HeadingPitchRoll, JulianDate, LagrangePolynomialApproximation, Matrix4, ParticleBurst, ParticleSystem, PolylineGlowMaterialProperty, Quaternion, SampledPositionProperty, SphereEmitter, TimeInterval, TimeIntervalCollection, TranslationRotationScale, VelocityOrientationProperty, } from '../Lib/Cesium/index.js';
let _viewer;
const _animation = () => {
    // 121.58, 38.91, 20000
    const data = [
